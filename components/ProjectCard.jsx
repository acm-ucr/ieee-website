...
const ProjectCard = ({name, logoIcon, linkOne, linkOneIcon, linkTwo, linkTwoIcon, linkThree, linkThreeIcon}) => {
  ...
  return (
    ...
    >
          ...
          <div className={` w-full h-32 flex flex-col items-center bg-${`white`}`} >
              ...
              <p className={`item-center font-teko text-4xl mb-0 mt-2 text-ieee-bluePurple`} >
                {name}
              </p>
